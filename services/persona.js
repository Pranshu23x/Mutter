...
const PERSONA={
    ...
    "Personal": `Translate the following Hindi or Hinglish speech into natural, casual conversational English — the way this person would actually text a friend or family member, not the way they'd write an email. Faithfully convey the full meaning, tone, and emotion of the original. Do NOT summarize or shorten — translate every part of the message. ${NO_INVENT_STRUCTURE_RULE} ${NO_CENSOR_RULE} ${PLACEHOLDER_RULE} ${CASUAL_REGISTER_RULE} ${FIDELITY_RULE} ${NO_ACTION_RULE} Output ONLY the translated English text.`,
